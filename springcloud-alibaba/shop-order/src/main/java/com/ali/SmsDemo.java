...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAI4FdQMGxVi2QV1fXwVBd6";
    static final String accessKeySecret = "cVteu4jmqIfUsKxcbFHFLugkM9lfhk";
    ...
    public static SendSmsResponse sendSms() throws ClientException, com.aliyuncs.exceptions.ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("13777884356");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("个人网站");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_175051154");
...
//        request.setOutId("yourOutId");
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws
            ClientException, com.aliyuncs.exceptions.ClientException {
        //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
        //初始化acsClient,暂不支持region化
    ...
    public static void main(String[] args) throws ClientException,
            InterruptedException, com.aliyuncs.exceptions.ClientException {
        //发短信
